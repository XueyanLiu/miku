 ...
 * transition.
 * <p align="center">
 * <img src="../../../../../images/trackrenderer_state.png"
...
public abstract class TrackRenderer implements ExoPlayerComponent {
   ...
   * @param positionUs The player's current position.
   * @param joining Whether this renderer is being enabled to join an ongoing playback. If true
   *          then {@link #onStarted} is guaranteed to be called immediately after this method
   *          returns
   ...
   *         or {@link #END_OF_TRACK_US} if the track is fully buffered, or {@link #UNKNOWN_TIME_US}
   *         if
