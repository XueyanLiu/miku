...
public class MediaCodecVideoTrackRenderer extends MediaCodecTrackRenderer {
  ...
  public interface EventListener extends MediaCodecTrackRenderer.EventListener {
     ...
     *          duration is timed from when the renderer was started or from when dropped frames
     *          were
     *          last reported (whichever was more recent), and not from when the first of the
     *          reported
     *          drops occurred.
     */
  ...
  // TODO: Use MediaFormat constants if these get exposed through the API. See [Internal:
  // b/14127601].
  ...
  protected void onInputFormatChanged(MediaFormatHolder holder) throws ExoPlaybackException {
    ...
    pendingPixelWidthHeightRatio = holder.format.pixelWidthHeightRatio == MediaFormat.NO_VALUE
        ? 1
